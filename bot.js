...
client.on("ready", () => {
  ...
  console.log(
    `Serving ${client.guilds.cache.size} guilds and ${client.users.cache.size} users!`
  );
});
  ...
  if (args[0][0] == config["prefix"]) {
    ...
    switch (args.shift()) {
      ...
      case "confirm":
        ...
        break;
      case "6teen":
        musicController.executeEgg(
          msg,
          "https://www.youtube.com/watch?v=Y_jby6F2H3k"
        );
        break;
      case "himark":
        musicController.executeEgg(
...
async function reload(moduleName, msg) {
  ...
  switch (moduleName.toLowerCase()) {
    ...
    case "chatfilter":
      ...
      break;
    case "verification":
      out = await msg.channel.send("Reloading verification module.");
      msgModule = null;
      delete require.cache[require.resolve("./modules/verify.js")];
      msgModule = require("./modules/verify.js");
      out.edit("Verification module reloaded");
      msg.delete();
      break;
    case "assemble":
